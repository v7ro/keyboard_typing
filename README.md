...
### ⌨️ Раскладки клавиатуры

- **ЙЦУКЕН** — стандартная русская раскладка  
- **Вызов** — экспериментальная раскладка, адаптированная вручную  
- **Зубачев** — альтернативная раскладка, основанная на принципах эргономики  
- Частотные данные (буквы, биграммы, триграммы) — собраны вручную на основе текстов: «Война и мир», частотные словари, технические статьи
