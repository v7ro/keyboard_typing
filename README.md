...
- ⚠️ **Мизинцы** — перегружаются в некоторых раскладках (например, `Зубарев`), что может привести к усталости и ошибкам.
- 🧠 **Большие пальцы** — в раскладке `Соколов` участвуют активнее, что снижает нагрузку на слабые мизинцы.
